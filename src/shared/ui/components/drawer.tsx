...
const drawerHostVariants = cva(
  [
    'fixed inset-0 m-0 flex h-dvh max-h-dvh w-dvw max-w-dvw bg-transparent p-0',
...
const drawerPanelVariants = cva(
  [
    ...
    'transition-[translate,opacity,display,overlay] transition-discrete',
    'duration-(--duration-standard) ease-brand',
    'open:translate-x-0 open:translate-y-0 open:opacity-100',
  ],
  {
    variants: {
      side: {
        ...
        start: [
          ...
          'starting:open:opacity-0 starting:open:-translate-x-full starting:open:rtl:translate-x-full',
        ],
        ...
        bottom: [
          ...
          'starting:open:opacity-0 starting:open:translate-y-full',
        ],
      },
    },
    defaultVariants: { side: 'end' },
