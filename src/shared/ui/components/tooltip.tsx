...
const tooltipVariants = cva(
  ...
  ],
  {
    ...
    variants: {
      placement: {
        top: 'bottom-full left-1/2 mb-2 -translate-x-1/2 translate-y-1 group-focus-within:translate-y-0 group-hover:translate-y-0',
        bottom:
          'top-full left-1/2 mt-2 -translate-x-1/2 -translate-y-1 group-focus-within:translate-y-0 group-hover:translate-y-0',
        start:
          'end-full top-1/2 me-2 translate-x-1 -translate-y-1/2 group-focus-within:translate-x-0 group-hover:translate-x-0',
        end: 'start-full top-1/2 ms-2 -translate-x-1 -translate-y-1/2 group-focus-within:translate-x-0 group-hover:translate-x-0',
      },
    },
