 ...
 * leading looks like a bug, not a variation. Exposing `font-display` as a separate boolean
...
const headingVariants = cva('text-text-primary', {
  variants: {
    size: {
      ...
      'display-xl':
        'font-display font-normal tracking-display leading-display text-5xl sm:text-6xl lg:text-7xl',
      'display-lg':
        'font-display font-normal tracking-display leading-display text-4xl sm:text-5xl',
      'display-md': 'font-display font-normal tracking-display leading-display text-3xl sm:text-4xl',
