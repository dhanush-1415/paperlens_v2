    ...
    <div className="flex flex-col gap-6 pb-8">
      ...
      <div className="relative flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="relative z-10 flex items-center gap-3">
          <Button className="h-10 font-bold shadow-md">Save All Changes</Button>
        </div>
      </div>
      ...
      <div className="mt-2">
        <div className="animate-in fade-in slide-in-from-bottom-2 flex w-full flex-col gap-6">
            ...
            <div className="mb-6 flex items-center gap-4 border-b border-border-subtle pb-4">
              ...
              <div>
                ...
                <Text size="sm" tone="secondary">
                  Control what events trigger automated emails.
                </Text>
              </div>
            </div>

            <div className="space-y-5">
              <label className="flex cursor-pointer items-start gap-4 rounded-xl border border-border-subtle bg-surface-2/50 p-4 transition-colors hover:bg-surface-2">
                <input
                  type="checkbox"
                  defaultChecked
                  className="mt-1 size-4 rounded border-border-strong text-brand-primary focus:ring-brand-primary"
                />
                <div className="flex-1">
                  <Text className="text-sm font-bold text-text-primary">Critical Risk Alerts</Text>
                  <Text size="xs" tone="secondary" className="mt-0.5">
                    Send immediate email when a scanned document flags as high-risk.
                  </Text>
                </div>
              ...
              <label className="flex cursor-pointer items-start gap-4 rounded-xl border border-border-subtle bg-surface-2/50 p-4 transition-colors hover:bg-surface-2">
                ...
                <div className="flex-1">
                  ...
                  <Text size="xs" tone="secondary" className="mt-0.5">
                    A rolled-up PDF report of all organizational scanning activity.
                  </Text>
                </div>
              ...
              <label className="flex cursor-pointer items-start gap-4 rounded-xl border border-border-subtle bg-surface-2/50 p-4 transition-colors hover:bg-surface-2">
                ...
                <div className="flex-1">
                  ...
                  <Text size="xs" tone="secondary" className="mt-0.5">
                    Occasional emails regarding platform updates.
                  </Text>
                </div>
              </label>
            </div>
          ...
          <div className="mt-8 grid grid-cols-1 gap-8 border-t border-border-subtle pt-8 md:grid-cols-3">
            ...
            <div className="md:col-span-2">
              <div className="rounded-[1.25rem] border border-border-subtle bg-surface-1 p-5 px-6 shadow-sm">
                <InboxAddress
                  initialAddress={
                    profile?.inboxToken ? formatInboxAddress(profile.inboxToken) : null
                  }
                />
              </div>
            </div>
          ...
          <div className="mt-8 grid grid-cols-1 gap-8 border-t border-border-subtle pt-8 md:grid-cols-3">
            ...
            <div className="md:col-span-2">
              <div className="flex items-center justify-between rounded-[1.25rem] border border-border-subtle bg-surface-1 p-4 px-5 shadow-sm">
                <div>
                  <Text className="text-sm font-bold text-text-primary">
                ...
                <Badge tone="safe" className="px-2 py-0.5 text-[10px] font-bold shadow-sm">
                  • Active
                </Badge>
              </div>
            </div>
          ...
          <div className="mt-2 grid grid-cols-1 gap-8 md:grid-cols-3">
            ...
            <div className="md:col-span-2">
              <div className="flex flex-col items-start justify-between gap-6 rounded-[1.25rem] border border-red-500/30 bg-red-50/10 p-5 px-6 shadow-sm sm:flex-row sm:items-center dark:bg-red-950/10">
                <div className="flex-1">
                  <Text className="text-sm font-bold text-text-primary">Delete account</Text>
                  <Text size="xs" tone="secondary" className="mt-1 max-w-lg leading-relaxed">
                ...
                {profile?.deletionRequestedAt ? <CancelDeletionButton /> : <DeleteAccountButton />}
              </div>
            </div>
          </div>
        </div>
