...
export function CurrentTimeWidget() {
  ...
  if (!time) {
    return (
      <div className="flex flex-col items-end opacity-0">
        ...
        <Text size="xs" tone="secondary" className="mt-1 font-medium tracking-wider uppercase">
          LOADING...
        </Text>
      </div>
    );
  ...
  return (
    <div className="flex flex-col items-end">
      <div className="font-mono text-3xl font-bold tracking-tight text-brand-primary drop-shadow-sm">
        {timeStr}
      </div>
      <Text size="xs" tone="secondary" className="mt-1 font-medium tracking-wider uppercase">
        {dateStr}
