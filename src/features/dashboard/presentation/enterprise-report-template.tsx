...
export const EnterpriseReportTemplate = React.forwardRef<
  HTMLDivElement,
  EnterpriseReportTemplateProps
>(({ data, dateRange }, ref) => {
  return (
    <div
      ref={ref}
    ...
    >
      ...
      >
        <div>
          ...
          <p style={{ margin: '8px 0 0 0', color: '#6b7280', fontSize: '14px' }}>
            Period: {format(dateRange.startDate, 'MMM d, yyyy')} —{' '}
            {format(dateRange.endDate, 'MMM d, yyyy')}
          </p>
        </div>
        <div style={{ textAlign: 'right' }}>
          <h2 style={{ margin: 0, fontSize: '18px', color: '#8b5cf6', fontWeight: 800 }}>
            ClearCut Enterprise
          </h2>
      ...
      <div style={{ display: 'flex', gap: '20px', marginBottom: '30px' }}>
        {[
          ...
          >
            ...
            <p
              style={{ margin: '8px 0 0 0', fontSize: '28px', color: stat.color, fontWeight: 900 }}
            >
              {stat.value}
            </p>
          </div>
      ...
      <div style={{ display: 'flex', gap: '20px', marginBottom: '30px' }}>
        ...
        >
          <h3 style={{ margin: '0 0 20px 0', fontSize: '16px', color: '#374151' }}>
            Processing Volume (Selected Period)
          </h3>
            ...
            {data.processingVolume.map((vol, i) => (
              <div
                ...
                style={{
                  ...
                  height: `${Math.max(5, (vol.count / Math.max(1, ...data.processingVolume.map((v) => v.count))) * 100)}%`,
                }}
              />
            ))}
          </div>
        ...
        >
          ...
          <div style={{ marginBottom: '16px' }}>
            ...
            >
              <span style={{ color: '#4b5563' }}>Verified Safe</span>
              <span style={{ color: '#10b981' }}>{data.riskDistribution.safePercentage}%</span>
            </div>
            <div style={{ height: '8px', backgroundColor: '#e5e7eb', borderRadius: '4px' }}>
              <div
                style={{
                  ...
                  borderRadius: '4px',
                  width: `${data.riskDistribution.safePercentage}%`,
                }}
              />
            </div>
          </div>
          ...
          <div style={{ marginBottom: '16px' }}>
            ...
            >
              <span style={{ color: '#4b5563' }}>Needs Review</span>
              <span style={{ color: '#f59e0b' }}>{data.riskDistribution.cautionPercentage}%</span>
            </div>
            <div style={{ height: '8px', backgroundColor: '#e5e7eb', borderRadius: '4px' }}>
              <div
                style={{
                  ...
                  borderRadius: '4px',
                  width: `${data.riskDistribution.cautionPercentage}%`,
                }}
              />
            </div>
          </div>
          ...
          <div>
            ...
            >
              <span style={{ color: '#4b5563' }}>High Risk</span>
              <span style={{ color: '#f43f5e' }}>{data.riskDistribution.criticalPercentage}%</span>
            </div>
            <div style={{ height: '8px', backgroundColor: '#e5e7eb', borderRadius: '4px' }}>
              <div
                style={{
                  ...
                  borderRadius: '4px',
                  width: `${data.riskDistribution.criticalPercentage}%`,
                }}
              />
            </div>
          </div>
      ...
      >
        ...
        {data.recentActivity.length === 0 && (
          <p style={{ textAlign: 'center', color: '#6b7280', padding: '20px 0', margin: 0 }}>
