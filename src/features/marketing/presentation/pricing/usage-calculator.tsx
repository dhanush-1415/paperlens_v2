 ...
 */
 ...
 return (
 <div className="relative overflow-hidden rounded-[2rem] border border-brand-primary/30 bg-surface-1/40 backdrop-blur-xl p-8 md:p-12 shadow-2xl">
 <div className="absolute top-0 right-0 w-64 h-64 bg-brand-primary/10 rounded-full blur-[80px] pointer-events-none -z-10" />
 ...
 className="w-full h-3 cursor-pointer appearance-none rounded-full bg-surface-2 accent-brand-primary border border-border-strong shadow-inner outline-none focus:ring-2 focus:ring-brand-primary/50"
 />
 </div>
 ...
 htmlFor={sliderId}
 aria-live="polite"
 className="flex flex-col gap-3 border-t border-border-strong/50 pt-6 mt-2"
 >
 <div className="flex items-center justify-between gap-4">
 <span className="text-sm font-medium text-text-secondary">
 {tier.name} base{overage > 0 ? <span className="text-brand-primary"> + {format(overage)} extra</span> : ''}
 </span>
 <span className="tabular text-3xl leading-none font-extrabold tracking-tight text-text-primary flex items-baseline gap-1.5">
