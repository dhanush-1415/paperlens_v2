...
export function PricingFaq() {
 return (
 <section aria-labelledby="pricing-faq-heading" className="w-full py-24 relative bg-canvas">
 <div className="w-[95%] md:w-[90%] lg:w-[80%] mx-auto">
 <div className="grid gap-12 lg:grid-cols-12">
 
 <div className="lg:col-span-5 flex flex-col gap-6 relative">
 <div className="sticky top-24">
 <span className="text-xs uppercase font-bold tracking-widest text-brand-primary">Questions</span>
 <h2 id="pricing-faq-heading" className="text-3xl md:text-4xl font-extrabold tracking-tight text-text-primary mt-2">
 The things worth asking before you pay
 </h2>
 <p className="mt-4 text-sm md:text-base text-text-secondary leading-relaxed">
 If yours is not here, ask us. A real person answers, and the answer is not a link back
 to this page.
 </p>
 </div>
 </div>
 ...
 >
 <p className="text-sm text-text-secondary leading-relaxed pb-4">
 {entry.answer}
 </p>
 </AccordionItem>
 ))}
