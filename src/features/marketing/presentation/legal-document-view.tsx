...
export function LegalDocumentView({ document, locale = 'en' }: LegalDocumentViewProps) {
  ...
  return (
    <div className="relative w-full overflow-hidden bg-canvas pb-24">
      <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(to_right,rgba(var(--border-strong-rgb),0.03)_1px,transparent_1px),linear-gradient(to_bottom,rgba(var(--border-strong-rgb),0.03)_1px,transparent_1px)] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)] bg-[size:4rem_4rem]" />
