        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col gap-6 text-left relative z-10">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 mt-2">
              <Link
                href={ROUTES.scan}
                className="group relative inline-flex items-center justify-center gap-3 rounded-full bg-brand-solid hover:bg-brand-solid-hover px-8 py-4 text-sm font-semibold text-text-on-brand transition-all hover:scale-[1.02] active:scale-[0.98] shadow-lg shadow-brand-primary/20"
              >
