    ...
    <section className="force-dark w-full py-24 relative overflow-hidden bg-canvas">
      ...
      <div className="w-[95%] md:w-[90%] lg:w-[80%] mx-auto px-6 relative z-10">
        <div className="border border-border-strong/50 bg-surface-1/50 backdrop-blur-3xl rounded-[3rem] p-10 md:p-16 lg:p-20 text-center flex flex-col items-center gap-10 relative overflow-hidden shadow-[0_30px_100px_-20px_rgba(0,0,0,0.6)] group">
          ...
          <ScrollReveal variant="fade-up" className="flex flex-col gap-5 relative z-10 max-w-3xl">
          ...
          <ScrollReveal variant="fade-up" delay={0.2} className="w-full max-w-4xl">
            <Link
              href={ROUTES.scan}
              className="relative z-10 border-2 border-dashed border-border-strong bg-surface-2/30 hover:bg-surface-2/60 hover:border-brand-primary/60 transition-all duration-500 rounded-[2rem] w-full py-8 px-12 flex flex-col items-center justify-center gap-4 cursor-pointer shadow-2xl hover:shadow-[0_0_40px_-10px_rgba(var(--brand-primary-rgb),0.3)] transform hover:-translate-y-1 group/drop"
            >
              <div className="p-4 rounded-xl bg-brand-primary/10 border border-brand-primary/20 text-brand-primary transition-all duration-500 group-hover/drop:scale-110 group-hover/drop:bg-brand-primary group-hover/drop:text-text-on-brand shadow-inner">
              ...
              <div className="flex flex-col gap-1 text-center mt-1">
                <span className="text-xl md:text-2xl font-bold text-text-primary">Drop your document here</span>
                ...
                <span className="text-xs text-text-tertiary mt-2 tracking-wide">Supports PDF, PNG, JPEG, DOCX (up to 10MB)</span>
              </div>
            </Link>
          </ScrollReveal>
          
          <ScrollReveal variant="fade-up" delay={0.3} className="flex flex-col items-center gap-4 relative z-10 mt-2">
