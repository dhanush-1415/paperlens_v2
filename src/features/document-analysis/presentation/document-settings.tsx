...
export function DocumentSettings({ documentId, initialLanguage = null, initialTone = 'simple' }: { documentId: string, initialLanguage?: string | null, initialTone?: 'simple' | 'professional' }) {
  ...
  return (
    <div className="flex flex-col gap-3 mx-1 my-2">
      {/* Tone Setting */}
      <div className="rounded-xl border border-border-subtle bg-surface-2 px-4 py-3 flex items-center justify-between gap-3 shadow-sm">
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            <p className="text-xs font-semibold text-text-primary leading-none">Explanation style</p>
            <p className="text-[11px] text-text-tertiary mt-1 leading-none">Plain language or full terminology</p>
          </div>
        </div>
        <div className="flex shrink-0 rounded-lg border border-border-strong bg-surface-1 p-1">
          {(['simple', 'professional'] as const).map(t => (
            <button
              ...
              className={cn(
                "flex items-center gap-1 rounded-md px-3 py-1.5 text-xs font-semibold transition-all duration-150 cursor-pointer",
                tone === t
      ...
      <div className="rounded-xl border border-border-subtle bg-surface-2 px-4 py-3 flex items-center justify-between gap-3 shadow-sm">
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            <p className="text-xs font-semibold text-text-primary leading-none">Response language</p>
            <p className="text-[11px] text-text-tertiary mt-1 leading-none">AI will reply in this language</p>
          </div>
        </div>
