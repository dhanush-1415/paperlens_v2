...
import { type AnalysisDraft, type DocumentAnalysisRepository } from '@/features/document-analysis';
      ...
      it('recomputes the score rather than echoing it back', async () => {
        ...
        const saved = unwrapOrThrow(
          await repository.save(
            draft({
              score: { value: 3, level: 'critical', counts: { critical: 9, caution: 9, safe: 9 } },
            }),
          ),
        );
