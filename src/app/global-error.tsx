...
const CRITICAL_CSS = `
  ...
  * { box-sizing: border-box; }
  ...
  .ge-title { margin: 0 0 0.5rem; font-size: 1.25rem; font-weight: 600; letter-spacing: -0.01em; }
  .ge-body  { margin: 0 0 1.5rem; font-size: 0.9375rem; line-height: 1.6; color: var(--ge-muted); }
