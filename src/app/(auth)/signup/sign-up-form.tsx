          ...
          <Field label="Email" error={fieldError('email')} required>
            {(field) => (
              <Input
                ...
                className={`rounded-xl border-border-strong/50 bg-surface-2/50 px-4 py-2.5 transition-all placeholder:text-text-tertiary focus:border-brand-primary focus:ring-2 focus:ring-brand-primary/20 focus:outline-none ${emailStatus === 'available' ? 'border-emerald-500/50 bg-emerald-500/5' : ''}`}
              />
            )}
          </Field>
