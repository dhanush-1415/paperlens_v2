      ...
      <div className="flex flex-col gap-6 md:gap-8">
        ...
        <div className="mt-2">
          <Link
            ...
            className="inline-flex w-full items-center justify-center gap-2 text-sm font-bold text-text-tertiary transition-colors duration-300 hover:-translate-x-1 hover:text-text-primary"
          >
